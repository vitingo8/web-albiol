  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <div className="mb-5 inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-[#ddb042]/10 text-[#ddb042] group-hover:bg-[#ddb042] group-hover:text-slate-950 transition-all duration-300">
          {icon}
        </div>
        ...
        <span className="inline-flex items-center text-sm font-medium text-[#ddb042] group-hover:text-[#ddb042]/80 transition-all gap-1 group-hover:gap-3">
          {readMore}
